...
map_root_dev() {
  ...
  case $ROOT_DEV in
    $MENDER_ROOTFS_PART_A)
      ...
      ROOT_HEADER="@@MENDER/LUKS_HEADER_DIR@@/@@MENDER/LUKS_ROOTFS_PART_A_DM_NAME@@.@@MENDER/LUKS_HEADER_EXT@@"
      ;;
    $MENDER_ROOTFS_PART_B)
      ROOT_DM_NAME="@@MENDER/LUKS_ROOTFS_PART_B_DM_NAME@@"
      ROOT_HEADER="@@MENDER/LUKS_HEADER_DIR@@/@@MENDER/LUKS_ROOTFS_PART_B_DM_NAME@@.@@MENDER/LUKS_HEADER_EXT@@"
      ;;
    *)
...
unlock_luks_partitions() {
  ...
  install -m 600 -D "" "${CRYPTSETUP_KEY_FILE}"
